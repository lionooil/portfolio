...
const ProfilePicture = () => {
  return (
    　<div className="flex-col my-auto">
      ...
      <motion.div initial={{ opacity: 0, y: 100 }} whileInView={{ opacity: 1, y: 0 }}  transition={{ duration: 0.4, delay: 0.3 }} viewport={{ once: true }} className="m-auto">
      <p>Lios - 竹下　凌/Takeshita Ryo</p>
      <p>1996年生まれ。かに座。</p>
