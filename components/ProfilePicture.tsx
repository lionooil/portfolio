...
const ProfilePicture = () => {
  return (
    ...
    　<div className="flex-col my-auto">
      ...
      <motion.div initial={{ opacity: 0, y: 100 }} whileInView={{ opacity: 1, y: 0 }}  transition={{ duration: 0.4, delay: 1 }} viewport={{ once: true }} className="m-8 md:my-auto md:mx-auto bg-white shadow p-8 rounded-md bg-opacity-50 md:text-xl">
